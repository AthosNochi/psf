...
@section('conteudo-view')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" maxlength="8" name="birth" placeholder="data de nascimento" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="gender" class="col-sm-4 col-form-label"> Genero:</label>
        <div class="col-sm-5">
            <input type="text" class="form-control" maxlength="10" name="gender" placeholder="Genero" required>
        </div>
    </div>
    <div class="form-group row">
